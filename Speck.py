...
class Speck:
    ...
    def stand(self):
        ...
        for i in range(0, 2, 1):
            self.move_queues[i].put([4, -10 - self.Legs[i].current_position[0], 150 - self.Legs[i].current_position[1],
                                     HIP_LENGTH - self.Legs[i].current_position[2]])
        for i in range(2, 4, 1):
            self.move_queues[i].put([4, 65 - self.Legs[i].current_position[0], 150 - self.Legs[i].current_position[1],
                                     HIP_LENGTH - self.Legs[i].current_position[2]])
