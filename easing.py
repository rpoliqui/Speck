"""
Code written by kevinmcaleer, obtained from GitHub
Slightly Modified to fit needs.
Source: https://github.com/kevinmcaleer/bubo-2t
"""
...
class TransitionBase:
    ...
    def func(self, t: float) -> Type[NotImplementedError]:
